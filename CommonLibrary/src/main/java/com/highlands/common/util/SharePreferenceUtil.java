...
public class SharePreferenceUtil {
    ...
    public static final String USE_IN_WIFI = "USE_IN_WIFI";     //  WIFI下使用
    public static final String MOBILE_TIPS = "MobileTips";     //  移动网络开启提醒
    public static final String TABLE_DATA = "table_data";     // 从支付申请app中传递过来的token
    public static final String FLOOR_ID = "floor_id";
    public static final String FLOOR_DATA = "floor_data";
