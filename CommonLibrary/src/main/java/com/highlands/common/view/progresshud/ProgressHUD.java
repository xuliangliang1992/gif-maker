...
package com.highlands.common.view.progresshud;
...
public class ProgressHUD {
    ...
    public ProgressHUD(Context context) {
        ...
        mWindowColor = context.getResources().getColor(R.color.progresshud_default_color);
        mAnimateSpeed = 1;
        mCornerRadius = 10;
        mIsAutoDismiss = true;
        mGraceTimeMs = 0;
     ...
     * @return Current HUD
     */
    public ProgressHUD setBackgroundColor(int color) {
        mWindowColor = color;
        return this;
    }
     ...
     * @return Current HUD
     */
    public ProgressHUD setLabel(String label, int color) {
     ...
     * @return Current HUD
     */
    public ProgressHUD setDetailsLabel(String detailsLabel, int color) {
    ...
    /**
     * Specify whether this HUD can be cancelled by using back_white button (default is false)
     * <p>
    ...
    /**
     * Specify a callback to run when using the back_white button (default is null)
     *
     * @param listener The code that will run if the user presses the back_white
     ...
     * @return Current HUD
     */
    public ProgressHUD setCancellable(DialogInterface.OnCancelListener listener) {
     ...
     * @return Current HUD
     */
    public ProgressHUD setGraceTime(int graceTimeMs) {
